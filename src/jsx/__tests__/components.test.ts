...
describe("JSX Components", () => {
  ...
  describe("複雑なコンポーネント", () => {
    ...
    it("Cardコンポーネントが正しく動作する", () => {
      ...
      const result = createSlideElement(
        Card,
        {
          title: "カードタイトル",
  ...
  describe("ネストしたコンポーネント", () => {
    it("コンポーネント内でコンポーネントを使用できる", () => {
      ...
      const button1 = createSlideElement(
        Button,
        { variant: "primary" },
        createSlideElement("text", { style: { color: "white" } }, "Primary"),
      );
      const button2 = createSlideElement(
        Button,
        { variant: "secondary" },
        ...
        children: [
          {
            ...
            children: [
              { type: "text", style: { color: "white" }, content: "Primary" },
            ],
          },
          {
            type: "frame",
            ...
            children: [
              { type: "text", style: { color: "white" }, content: "Secondary" },
            ],
          },
        ],
      });
  ...
  describe("エッジケース", () => {
    ...
    it("falsy値をフィルタする", () => {
      ...
      const result = createSlideElement(ConditionalComponent, {
        showFirst: false,
      });
